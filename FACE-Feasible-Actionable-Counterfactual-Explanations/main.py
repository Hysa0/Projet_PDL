...
def main_synthetic_face(epsilon=0.2, tp=0.6, td=0.001):
	...
	datasetName = 'synthetic_face_dataset'
	data, FEATURE_COLUMNS, TARGET_COLUMNS = load_synthetic_face()
	...
	pk.dump(clf, open(r".\FACE-Feasible-Actionable-Counterfactual-Explanations\tmp\LR_classifier_face.pk".format(datasetName, epsilon, td), 'wb'))
	pk.dump(recourse_points, open(r".\FACE-Feasible-Actionable-Counterfactual-Explanations\tmp\Face_robustness.pk".format(datasetName, epsilon, td), 'wb'))
...
def main(epsilon=0.2, tp=0.6, td=0.001, datasetName="no_constraint", expIter='0.0'):
	"""
	tp = 0.6 # Prediction threshold
...
def main_train_test(epsilon=0.2, tp=0.6, td=0.001, datasetName='synthetic_face_dataset', expIter='0.0'):
	"""
	tp = 0.6 # Prediction threshold
	td = 0.0001 # density threshold
	epsilon = 0.3 # margin for creating connections in graphs
	...
	data, data_recourse_test, FEATURE_COLUMNS, TARGET_COLUMNS = load_synthetic_face()
	TEST_SIZE = 0.8
...
if __name__=="__main__":
	...
	main_synthetic_face(epsilon=0.8) #datasetName='synthetic_face')
