...
def load_synthetic_one_hot():
	dataPath = r".\FACE-Feasible-Actionable-Counterfactual-Explanations\data\synthetic_one_hot"
	data = pd.read_pickle(open(dataPath, 'rb')).data_frame_kurz
...
def load_synthetic_face():
	dataPath = r".\FACE-Feasible-Actionable-Counterfactual-Explanations\data\synthetic_face_dataset.pk"
